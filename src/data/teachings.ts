...
export const teachings: Teaching[] = [
  {
    slug: "mastering-the-jewish-secrets-of-wealth-creation",
    title: "Mastering the Jewish Secrets of Wealth Creation",
    series: "The Jewish Secrets of Wealth Creation",
  ...
  {
    slug: "the-laws-of-kingdom-governance",
    title: "The Laws of Kingdom Governance",
    speaker: "Dr. David Ogbueli",
    format: "video",
    durationMin: 42,
  ...
  {
    slug: "laws-that-govern-nations",
    title: "The Laws That Govern Nations",
    series: "The Laws of Kingdom Governance",
    speaker: "Dr. David Ogbueli",
    format: "video",
    durationMin: 48,
  ...
  },
  {
    ...
    series: "The Laws of Proper Speech",
    speaker: "Dr. David Ogbueli",
    format: "video",
    durationMin: 44,
  ...
  {
    slug: "the-tongue-and-your-testimony",
    title: "The Tongue and Your Testimony",
    series: "The Laws of Proper Speech",
    speaker: "Dr. David Ogbueli",
    format: "audio",
    durationMin: 38,
  ...
  },
  {
    ...
    title: "Solomon's Secret of Wisdom",
    series: "Pillars of Wisdom & Wealth",
    speaker: "Dr. David Ogbueli",
    format: "video",
    durationMin: 56,
  ...
  {
    slug: "the-jewish-mindset-of-increase",
    title: "The Jewish Mindset of Increase",
    series: "Pillars of Wisdom & Wealth",
    speaker: "Dr. David Ogbueli",
    format: "article",
    durationMin: 14,
  ...
  {
    slug: "raising-leaders-who-last",
    title: "Raising Leaders Who Last",
    series: "The Leader's Foundation",
    speaker: "Dr. David Ogbueli",
    format: "video",
    durationMin: 50,
  ...
  {
    slug: "character-before-crowns",
    title: "Character Before Crowns",
    series: "The Leader's Foundation",
    speaker: "Dr. David Ogbueli",
    format: "audio",
    durationMin: 41,
  ...
  {
    slug: "the-interior-life-of-a-leader",
    title: "The Interior Life of a Leader",
    series: "Depths of Devotion",
    speaker: "Dr. David Ogbueli",
    format: "audio",
    durationMin: 36,
  ...
  {
    slug: "kingdom-principles-in-business",
    title: "Kingdom Principles in Business",
    series: "Marketplace Dominion",
    speaker: "Dr. David Ogbueli",
    format: "video",
    durationMin: 47,
    thumbnail: "/images/pastor/hero-stadium-arms-wide.jpg",
  ...
  {
    slug: "the-night-of-glory-charge",
    title: "The Night of Glory Charge",
    series: "Marketplace Dominion",
    speaker: "Dr. David Ogbueli",
    format: "video",
    durationMin: 33,
...
export const featuredTeaching: Teaching =
  teachings.find((t) => t.featured) ?? teachings[0];
