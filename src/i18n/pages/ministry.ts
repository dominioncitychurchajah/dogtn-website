...
export const ministryCopy: Record<Locale, MinistryCopy> = {
  en: {
    ...
    heroSubtitle: "Interconnected ministries, one mandate, to raise leaders that transform nations.",
  ...
  fr: {
    ...
    heroSubtitle: "Ministères interconnectés, un seul mandat, former des leaders qui transforment les nations.",
  ...
  pt: {
    ...
    heroSubtitle: "Ministérios interligados, um único mandato, formar líderes que transformam nações.",
  ...
  sw: {
    ...
    heroSubtitle: "Huduma zilizounganishwa, agizo moja, kulea viongozi wanaobadilisha mataifa.",
  ...
  ar: {
    ...
    heroSubtitle: "خدمات مترابطة، تكليف واحد، إعداد قادة يغيّرون الأمم.",
