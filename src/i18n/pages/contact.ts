...
export const contactCopy: Record<Locale, ContactCopy> = {
  en: {
    responsePromise: "Average response time: 3 hours",
    responseFallback: "Haven't heard back within 3 hours? Call or chat",
    ...
    trustResponse: "Avg. response: 3 hours",
  ...
  fr: {
    responsePromise: "Temps de réponse moyen : 3 heures",
    responseFallback: "Pas de réponse sous 3 heures ? Appelez ou écrivez",
    ...
    trustResponse: "Réponse moyenne : 3 heures",
    ...
    officesHeading: "Bureaux dans le Monde",
  ...
  pt: {
    responsePromise: "Tempo médio de resposta: 3 horas",
    responseFallback: "Sem resposta em 3 horas? Ligue ou converse",
    ...
    trustResponse: "Resposta média: 3 horas",
    ...
    officesHeading: "Escritórios Globais",
  ...
  sw: {
    responsePromise: "Wastani wa muda wa kujibu: saa 3",
    responseFallback: "Hujapata jibu ndani ya saa 3? Piga simu au ujumbe",
    ...
    trustResponse: "Wastani wa kujibu: saa 3",
    ...
    officesHeading: "Ofisi za Kimataifa",
  ...
  ar: {
    responsePromise: "متوسط وقت الاستجابة: 3 ساعات",
    responseFallback: "لم تتلقَّ ردًا خلال 3 ساعات؟ اتصل أو راسلنا",
    heroTitlePre: "لنبدأ ",
    ...
    trustResponse: "متوسط الرد: 3 ساعات",
    ...
    officesHeading: "المكاتب حول العالم",
