...
export const leadershipCopy: Record<Locale, LeadershipCopy> = {
  en: {
    ...
    metaDescription:
      "Assess your growth, enter the right leadership pathway, and continue your formation through structured training designed for global impact.",
    heroEyebrow: "Institutional Ecosystem",
    heroTitle: "The Leadership Engine",
    heroSubtitle:
      "Assess your growth, enter the right leadership pathway, and continue your formation through structured training designed for global impact.",
    startAssessment: "Start Leadership Assessment",
    exploreCourses: "Explore DLI Courses",
    bentoTitle: "Find your level in 7 minutes",
    bentoSubtitle: "Our precision engine measures five core pillars of leadership formation.",
    ...
    pathwaySubtitle:
      "A structured journey from foundational ethics to global institutional governance.",
    pathway: [
      { title: "DLI Basic", caption: "Fundamentals of Character & Purpose" },
      { title: "DLI Advanced", caption: "Visionary Management & Strategy" },
      { title: "Certification", caption: "Professional Governance Mastery" },
      { title: "Leadership Tracks", caption: "Specialized Executive Deployment" },
    ],
    ...
    blurbs: [
      "Master the internal architecture of leadership. Focus on personal ethics, spiritual identity, and the discovery of primary purpose.",
      "Equipping leaders for institutional influence. Systems thinking, resource management, and organizational culture design.",
    ],
    viewCourse: "View Course",
    journalTitle: "The Leadership Journal",
    validateTitle: "Validate Credentials",
    validateBody:
      "Instantly verify the authenticity of DOGTN Leadership Institute certificates and professional credentials.",
    certPlaceholder: "Enter certificate ID (e.g. DLI-2026-0891)",
    verify: "Verify",
    blockchainNote: "Blockchain-secured verification protocol enabled.",
    certNote: "Secured verification of every DLI credential we issue.",
  },
  fr: {
    metaTitle: "Leadership",
    metaDescription:
