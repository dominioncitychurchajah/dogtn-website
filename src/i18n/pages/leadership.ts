...
export const leadershipCopy: Record<Locale, LeadershipCopy> = {
  en: {
    ...
    bentoTitle: "Find Your Level in 10 Questions",
  ...
  fr: {
    ...
    bentoTitle: "Trouvez votre niveau en 10 questions",
    bentoSubtitle:
  ...
  pt: {
    ...
    bentoTitle: "Descubra o seu nível em 10 perguntas",
    bentoSubtitle:
  ...
  sw: {
    ...
    bentoTitle: "Tambua kiwango chako kwa maswali 10",
  ...
  ar: {
    ...
    bentoTitle: "اكتشف مستواك في 10 أسئلة",
